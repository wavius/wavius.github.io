...
Using the tool is pretty straightforward. Running `wvs` on its own drops you into an interactive search mode, or you can skip straight to what you want by passing a query like `wvs breaking bad`.
